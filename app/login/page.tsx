...
function Logo() {
  return (
    <svg width="130" height="48" viewBox="0 0 244 90" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="lg" x1="20" y1="20" x2="72" y2="72" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1FAEB5"/><stop offset="1" stopColor="#0E5FA8"/>
        </linearGradient>
      </defs>
      <rect x="20" y="19" width="52" height="52" rx="15" fill="url(#lg)"/>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0B1B2B", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "15%", left: "10%", width: 400, height: 400, background: "radial-gradient(circle, rgba(31,174,181,0.08) 0%, transparent 70%)", filter: "blur(40px)" }}/>
        <div style={{ position: "absolute", bottom: "15%", right: "10%", width: 300, height: 300, background: "radial-gradient(circle, rgba(14,95,168,0.1) 0%, transparent 70%)", filter: "blur(40px)" }}/>
      </div>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  background: "rgba(232,244,246,0.06)", border: "1px solid rgba(232,244,246,0.12)",
                  color: "#E8F4F6", fontFamily: "Manrope, sans-serif", fontSize: 15,
